;(function () {
  ...
  function FastClick(layer, options) {
    ...
    const context = this;
    for (const i = 0, l = methods.length; i < l; i++) {
  ...
  FastClick.prototype.onTouchStart = function(event) {
    const targetElement, touch, selection;
  ...
  FastClick.prototype.onTouchEnd = function(event) {
    const forElement, trackingClickStart, targetTagName, scrollParent, touch, targetElement = this.targetElement;
