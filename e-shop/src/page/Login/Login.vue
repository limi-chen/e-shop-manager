       ...
       <div class="login-inner">
        ...
        <form>
          ...
          <div :class="{current: loginMode}">
            ...
            <section class="login-hint">温馨提示：未注册商城帐号的手机号，登录时将自动注册，且代表已同意
              ...
              <section class="login-message">
                <input type="text" maxlength="11" placeholder="用户名/手机/邮箱" v-model="user_name">
	              ...
	              <section class="login-message">
	                ...
	                <img ref="captcha" class="get-verification" src="http://localhost:3000/api/captcha" @click.prevent="getCaptcha()"/>
...
<script>
	...
	export default {
		...
		data () {
			return {
				loginMode: true ,  //登录方式  : true 验证码登录  false 用户密码登录
				phone: '',   //手机号码
				countDown: 0,  //倒计时
