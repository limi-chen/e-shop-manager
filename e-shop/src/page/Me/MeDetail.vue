<template>
  <div class="user-detail">
    ...
    <!--选择出生年月-->
    <mt-datetime-picker type="date" ref="picker"
      year-format="{value} 年"
...
<script>
	...
	export default {
		...
		methods: {
			...
			async saveUserInfo () {
				//3.1 请求接口
				let res = await changeUserInfo(this.userInfo.id, this.user_name, this.user_sex, this.user_birthday, this.user_address, this.user_sign);
