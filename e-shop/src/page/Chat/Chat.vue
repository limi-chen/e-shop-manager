  ...
  <div class="chat">
      ...
      <section>
        <div class="shopCart_list_con" v-for="(goods, index) in cartGoods" :key="index">
          <div class="list_con_left">
            <a href="javascript:;" class="cart_check_box" :checked="goods.checked" @click.stop="singerGoodsSelected(goods)"></a>
          </div>
    ...
    <div id="tab_bar">
      <div class="tab-bar-left">
        <a href="javascript:;" class="cart_check_box" :checked="isSelectAll" @click.stop="selectAll(isSelectAll)"></a>
...
<script>
	...
	import {delShopToCart} from './../../api/index'
	...
	export default {
		...
		methods: {
			...
			clickTrash(goods){
				...
				//删除服务器中的商品
				let res = delShopToCart(this.userInfo.id, goods.goods_id);
				//console.log(res);
			}
		},
		filters: {
